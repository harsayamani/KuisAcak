...
public class Login2Activity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignInButton googleButton = findViewById(R.id.googleLogin);
        googleButton.setOnClickListener(this);
        firebaseConnect2();
    }

    private void firebaseConnect2() {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() != null) {
                    startActivity(new Intent(Login2Activity.this, DashboardPemain.class));
                    finish();
                }
            }
        };
